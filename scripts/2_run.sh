...
chmod +x ../src/Snake.Items/run.sh

../src/Snake.Gameloop/run.sh & ../src/Snake.Input/run.sh & ../src/Snake.Leaderboard/run.sh & ../src/Snake.Map/run.sh & ../src/Snake.User/run.sh & ../src/Snake.Items/run.sh &
npm start --prefix ../src/Snake &
npm start --prefix ../src/Snake.Input/Snake.Input.Web &
npm start --prefix ../src/Snake.Items/Snake.Items.Web &
